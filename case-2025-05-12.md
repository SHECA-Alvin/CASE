...
- **Was issuance stopped in response to this incident, and why or why not?** The issuance of certificates has not been stopped. Since there is no problem with the format of the three certificates, SHECA is restoring the data of the three certificates through code to repair the OCSP responses of the three certificates.
- **Analysis:** N/A
